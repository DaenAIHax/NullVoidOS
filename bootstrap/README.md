...
Where the project's `main` branch builds a container-centric cybersecurity
workbench on Fedora Atomic, this direction asks a different question: *what
does an operating system look like when an autonomous agent is the primary
user from boot moment 0?* — and what has to be true for that to be safe.
